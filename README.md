...
### ```window_maker()```
Jedna z funkcji inicjalizacyjnych tworzących okno
Własności okna:
    szerokość: 1200 pix
    wysokość: 600 pix
...
### ```main()```
Główna funkcja odpowiedzialna za działanie programu i połączenie wszystkich funkcji tak aby ze sobą wspólgrały
Jest wykonywana tylko gdy modół jest wykonywany jako program główny
